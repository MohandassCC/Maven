	...
	function createSourceEndpoint(jp,outputCount, objectDomId,
		...
		for (var i = 1; i <= outputCount; i++) {
			...
			var sourceEndpointSpec = {
					endpoint: "Dot",
					anchors : [ nodeXPosition, nodeYPosition,	connectorXDirection, connectorYDirection ],					
	...
	function createTargetEndpoint(jp,inputCount, objectDomId,
		...
		for (var i = 1; i <= inputCount; i++) {
			...
			var targetEndpointSpec = {
		            ...
		            isSource: true,
		            connector: [ "Flowchart", { stub: [20,60], gap: 15, cornerRadius: 5, alwaysRespectStubs: true } ],
...
//						sourceObjectId);
	...
	function removeObject(deleteObject, context,
	 ...
	 jsPlumb.fire("jsPlumbDemoLoaded", initWorkflow);
